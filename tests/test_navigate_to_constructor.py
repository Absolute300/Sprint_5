...
class TestNavigateConstructor:
    ...
    def test_navigate_to_constructor_from_personal_account_button_constructor(self, driver):    
        ...
        driver.find_element(*Registration_Locators.CONSTRUCTOR_BUTTON).click()
        WebDriverWait(driver, 8).until(EC.visibility_of_element_located(Registration_Locators.ORDER_BUTTON))

        assert driver.find_element(*Registration_Locators.ORDER_BUTTON).is_displayed()

    # Переход по клику на лого «stellar burgers» 
    def test_navigate_to_constructor_from_personal_account_button_logo(self, driver):    
        ...
        driver.find_element(*Registration_Locators.LOGO_BUTTON).click()
        WebDriverWait(driver, 8).until(EC.visibility_of_element_located(Registration_Locators.ORDER_BUTTON))
